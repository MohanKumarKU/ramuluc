    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonUpstreamEcho.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonUpstreamEcho.setText("SENT");
